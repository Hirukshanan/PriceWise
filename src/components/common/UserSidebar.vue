...
<template>
  ...
  >
    <!-- ── HEADER ────────────────────────────────────────────────── -->
    <header class="relative overflow-hidden px-5 py-5 shrink-0">
      <!-- Gradient background -->
      <div
    ...
    >
      ...
      <section aria-labelledby="section-activity">
        <div class="flex items-center gap-2 px-3 pb-1 mb-0.5" id="section-activity">
          <svg class="w-4 h-4 text-gray-400 dark:text-slate-500 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        >
          ...
          <span class="flex-1 text-sm font-semibold">Comparison History</span>
          <svg class="w-4 h-4 text-gray-300 dark:text-slate-600 group-hover:text-blue-400 transition-colors shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
      ...
      <section aria-labelledby="section-settings">
        <div class="flex items-center gap-2 px-3 pb-1 mb-0.5" id="section-settings">
          <svg class="w-4 h-4 text-gray-400 dark:text-slate-500 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        <div class="space-y-1">
          ...
          >
            ...
            <span class="flex-1 text-sm font-semibold">Update Profile</span>
            <svg class="w-4 h-4 text-gray-300 dark:text-slate-600 group-hover:text-blue-400 transition-colors shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <polyline points="9 18 15 12 9 6"/>
            </svg>
          </button>
    ...
    <!-- ── FOOTER ─────────────────────────────────────────────────── -->
    <footer class="shrink-0 px-4 py-3 border-t border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900">
      <button
        @click="emit('logout')"
        class="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-full border-2 border-emerald-500 text-emerald-600 dark:text-emerald-400 font-bold text-sm hover:bg-emerald-50 dark:hover:bg-emerald-900/20 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
